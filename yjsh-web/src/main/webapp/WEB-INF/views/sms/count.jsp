...
<html>
	<head>
		...
		<!--index js css-->
		<script type="text/javascript" src="${ctx}/assets/js/count.js" ></script>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-info ">
							<div class="panel-heading">短信统计</div>
							<div class="panel-body">
								...
								<!--search end-->
								<!-- datatables -->
								<table class="table table-hover table-striped table-bordered" id="count_table">
									<thead>
										<tr>
											<th>企业ID</th>
											<th>企业名称</th>
